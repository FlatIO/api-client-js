...
(function(root, factory) {
  ...
  describe('CollectionCapabilities', function() {
    it('should create an instance of CollectionCapabilities', function() {
      // uncomment below and update the code to test CollectionCapabilities
      //var instance = new FlatApi.CollectionCapabilities();
    ...
    it('should have the property canAddScores (base name: "canAddScores")', function() {
      // uncomment below and update the code to test the property canAddScores
      //var instance = new FlatApi.CollectionCapabilities();
      //expect(instance).to.be();
    });

    it('should have the property canDeleteScores (base name: "canDeleteScores")', function() {
      // uncomment below and update the code to test the property canDeleteScores
      //var instance = new FlatApi.CollectionCapabilities();
      //expect(instance).to.be();
    });
