...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlatApi.ScoreCollaboratorCreation();
  });
  ...
  describe('ScoreCollaboratorCreation', function() {
    it('should create an instance of ScoreCollaboratorCreation', function() {
      // uncomment below and update the code to test ScoreCollaboratorCreation
      //var instane = new FlatApi.ScoreCollaboratorCreation();
      //expect(instance).to.be.a(FlatApi.ScoreCollaboratorCreation);
    });
