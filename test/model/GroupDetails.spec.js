...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlatApi.GroupDetails();
  });
  ...
  describe('GroupDetails', function() {
    it('should create an instance of GroupDetails', function() {
      // uncomment below and update the code to test GroupDetails
      //var instance = new FlatApi.GroupDetails();
      //expect(instance).to.be.a(FlatApi.GroupDetails);
    });
