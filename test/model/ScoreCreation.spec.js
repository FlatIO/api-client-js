...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlatApi.ScoreCreation();
  });
  ...
  describe('ScoreCreation', function() {
    it('should create an instance of ScoreCreation', function() {
      // uncomment below and update the code to test ScoreCreation
      //var instane = new FlatApi.ScoreCreation();
      //expect(instance).to.be.a(FlatApi.ScoreCreation);
    });
    ...
    it('should have the property dataEncoding (base name: "dataEncoding")', function() {
      // uncomment below and update the code to test the property dataEncoding
      //var instane = new FlatApi.ScoreCreation();
      //expect(instance).to.be();
    });
    ...
    it('should have the property googleDriveFolder (base name: "googleDriveFolder")', function() {
      // uncomment below and update the code to test the property googleDriveFolder
      //var instane = new FlatApi.ScoreCreation();
      //expect(instance).to.be();
    });
