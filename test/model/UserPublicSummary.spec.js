...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlatApi.UserPublicSummary();
  });
  ...
  describe('UserPublicSummary', function() {
    it('should create an instance of UserPublicSummary', function() {
      // uncomment below and update the code to test UserPublicSummary
      //var instane = new FlatApi.UserPublicSummary();
      //expect(instance).to.be.a(FlatApi.UserPublicSummary);
    });
    ...
    it('should have the property classRole (base name: "classRole")', function() {
      // uncomment below and update the code to test the property classRole
      //var instane = new FlatApi.UserPublicSummary();
      //expect(instance).to.be();
    });
