...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlatApi.ScoreCommentCreation();
  });
  ...
  describe('ScoreCommentCreation', function() {
    it('should create an instance of ScoreCommentCreation', function() {
      // uncomment below and update the code to test ScoreCommentCreation
      //var instane = new FlatApi.ScoreCommentCreation();
      //expect(instance).to.be.a(FlatApi.ScoreCommentCreation);
    });
