...
(function(root, factory) {
  ...
  describe('ScoreDataEncoding', function() {
    it('should create an instance of ScoreDataEncoding', function() {
      // uncomment below and update the code to test ScoreDataEncoding
      //var instane = new FlatApi.ScoreDataEncoding();
      //expect(instance).to.be.a(FlatApi.ScoreDataEncoding);
    });
