...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlatApi.ScoreLikesCounts();
  });
  ...
  describe('ScoreLikesCounts', function() {
    it('should create an instance of ScoreLikesCounts', function() {
      // uncomment below and update the code to test ScoreLikesCounts
      //var instane = new FlatApi.ScoreLikesCounts();
      //expect(instance).to.be.a(FlatApi.ScoreLikesCounts);
    });
