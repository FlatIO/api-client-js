...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlatApi.ScoreComment();
  });
  ...
  describe('ScoreComment', function() {
    it('should create an instance of ScoreComment', function() {
      // uncomment below and update the code to test ScoreComment
      //var instane = new FlatApi.ScoreComment();
      //expect(instance).to.be.a(FlatApi.ScoreComment);
    });
    ...
    it('should have the property rawComment (base name: "rawComment")', function() {
      // uncomment below and update the code to test the property rawComment
      //var instane = new FlatApi.ScoreComment();
      //expect(instance).to.be();
    });
    ...
    it('should have the property resolvedBy (base name: "resolvedBy")', function() {
