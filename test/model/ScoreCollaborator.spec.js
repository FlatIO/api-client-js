...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlatApi.ScoreCollaborator();
  });
  ...
  describe('ScoreCollaborator', function() {
    it('should create an instance of ScoreCollaborator', function() {
      // uncomment below and update the code to test ScoreCollaborator
      //var instane = new FlatApi.ScoreCollaborator();
      //expect(instance).to.be.a(FlatApi.ScoreCollaborator);
    });
