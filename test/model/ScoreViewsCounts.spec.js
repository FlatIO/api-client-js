...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlatApi.ScoreViewsCounts();
  });
  ...
  describe('ScoreViewsCounts', function() {
    it('should create an instance of ScoreViewsCounts', function() {
      // uncomment below and update the code to test ScoreViewsCounts
      //var instane = new FlatApi.ScoreViewsCounts();
      //expect(instance).to.be.a(FlatApi.ScoreViewsCounts);
    });
