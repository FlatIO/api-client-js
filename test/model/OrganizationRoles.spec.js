...
(function(root, factory) {
  ...
  describe('OrganizationRoles', function() {
    it('should create an instance of OrganizationRoles', function() {
      // uncomment below and update the code to test OrganizationRoles
      //var instane = new FlatApi.OrganizationRoles();
      //expect(instance).to.be.a(FlatApi.OrganizationRoles);
    });
