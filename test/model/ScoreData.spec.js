...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlatApi.ScoreData();
  });
  ...
  describe('ScoreData', function() {
    it('should create an instance of ScoreData', function() {
      // uncomment below and update the code to test ScoreData
      //var instane = new FlatApi.ScoreData();
      //expect(instance).to.be.a(FlatApi.ScoreData);
    });
