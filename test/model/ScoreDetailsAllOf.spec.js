...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlatApi.ScoreDetailsAllOf();
  });
  ...
  describe('ScoreDetailsAllOf', function() {
    it('should create an instance of ScoreDetailsAllOf', function() {
      // uncomment below and update the code to test ScoreDetailsAllOf
      //var instane = new FlatApi.ScoreDetailsAllOf();
      //expect(instance).to.be.a(FlatApi.ScoreDetailsAllOf);
    });
