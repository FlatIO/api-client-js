...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlatApi.ScoreFork();
  });
  ...
  describe('ScoreFork', function() {
    it('should create an instance of ScoreFork', function() {
      // uncomment below and update the code to test ScoreFork
      //var instane = new FlatApi.ScoreFork();
      //expect(instance).to.be.a(FlatApi.ScoreFork);
    });
