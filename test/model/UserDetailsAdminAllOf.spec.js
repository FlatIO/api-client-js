...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlatApi.UserDetailsAdminAllOf();
  });
  ...
  describe('UserDetailsAdminAllOf', function() {
    it('should create an instance of UserDetailsAdminAllOf', function() {
      // uncomment below and update the code to test UserDetailsAdminAllOf
      //var instane = new FlatApi.UserDetailsAdminAllOf();
      //expect(instance).to.be.a(FlatApi.UserDetailsAdminAllOf);
    });
