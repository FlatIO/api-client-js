...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlatApi.ScoreRevision();
  });
  ...
  describe('ScoreRevision', function() {
    it('should create an instance of ScoreRevision', function() {
      // uncomment below and update the code to test ScoreRevision
      //var instane = new FlatApi.ScoreRevision();
      //expect(instance).to.be.a(FlatApi.ScoreRevision);
    });
