...
(function(root, factory) {
  ...
  describe('ScoreDetails', function() {
    ...
    it('should have the property durationTime (base name: "durationTime")', function() {
      // uncomment below and update the code to test the property durationTime
      //var instane = new FlatApi.ScoreDetails();
      //expect(instance).to.be();
    });

    it('should have the property numberMeasures (base name: "numberMeasures")', function() {
      // uncomment below and update the code to test the property numberMeasures
      //var instane = new FlatApi.ScoreDetails();
      //expect(instance).to.be();
    });

    it('should have the property mainTempoQpm (base name: "mainTempoQpm")', function() {
      // uncomment below and update the code to test the property mainTempoQpm
      //var instane = new FlatApi.ScoreDetails();
      //expect(instance).to.be();
    });
