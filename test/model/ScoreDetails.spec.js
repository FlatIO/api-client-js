...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlatApi.ScoreDetails();
  });
  ...
  describe('ScoreDetails', function() {
    it('should create an instance of ScoreDetails', function() {
      // uncomment below and update the code to test ScoreDetails
      //var instane = new FlatApi.ScoreDetails();
      //expect(instance).to.be.a(FlatApi.ScoreDetails);
    });
    ...
    it('should have the property parentScore (base name: "parentScore")', function() {
      // uncomment below and update the code to test the property parentScore
      //var instane = new FlatApi.ScoreDetails();
      //expect(instance).to.be();
    });
