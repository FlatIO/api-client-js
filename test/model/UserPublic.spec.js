...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlatApi.UserPublic();
  });
  ...
  describe('UserPublic', function() {
    it('should create an instance of UserPublic', function() {
      ...
      //var instane = new FlatApi.UserPublic();
      //expect(instance).to.be.a(FlatApi.UserPublic);
    });
    ...
    it('should have the property likedScoresCount (base name: "likedScoresCount")', function() {
    ...
    it('should have the property ownedPublicScoresCount (base name: "ownedPublicScoresCount")', function() {
      // uncomment below and update the code to test the property ownedPublicScoresCount
      //var instane = new FlatApi.UserPublic();
      //expect(instance).to.be();
    });
