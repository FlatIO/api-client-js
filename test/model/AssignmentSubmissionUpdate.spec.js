...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlatApi.AssignmentSubmissionUpdate();
  });
  ...
  describe('AssignmentSubmissionUpdate', function() {
    it('should create an instance of AssignmentSubmissionUpdate', function() {
      // uncomment below and update the code to test AssignmentSubmissionUpdate
      //var instance = new FlatApi.AssignmentSubmissionUpdate();
      //expect(instance).to.be.a(FlatApi.AssignmentSubmissionUpdate);
    });
