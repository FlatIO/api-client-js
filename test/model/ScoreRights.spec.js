...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlatApi.ScoreRights();
  });
  ...
  describe('ScoreRights', function() {
    it('should create an instance of ScoreRights', function() {
      // uncomment below and update the code to test ScoreRights
      //var instane = new FlatApi.ScoreRights();
      //expect(instance).to.be.a(FlatApi.ScoreRights);
    });
