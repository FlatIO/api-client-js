...
(function(root, factory) {
  ...
  describe('ScorePrivacy', function() {
    it('should create an instance of ScorePrivacy', function() {
      // uncomment below and update the code to test ScorePrivacy
      //var instane = new FlatApi.ScorePrivacy();
      //expect(instance).to.be.a(FlatApi.ScorePrivacy);
    });
