...
(function(root, factory) {
  ...
  describe('ScoreRevisionCreation', function() {
    it('should create an instance of ScoreRevisionCreation', function() {
      // uncomment below and update the code to test ScoreRevisionCreation
      //var instane = new FlatApi.ScoreRevisionCreation();
    ...
    it('should have the property autosave (base name: "autosave")', function() {
      // uncomment below and update the code to test the property autosave
      //var instane = new FlatApi.ScoreRevisionCreation();
      //expect(instance).to.be();
    });
