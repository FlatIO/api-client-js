...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlatApi.ScoreCommentUpdate();
  });
  ...
  describe('ScoreCommentUpdate', function() {
    it('should create an instance of ScoreCommentUpdate', function() {
      // uncomment below and update the code to test ScoreCommentUpdate
      //var instane = new FlatApi.ScoreCommentUpdate();
      //expect(instance).to.be.a(FlatApi.ScoreCommentUpdate);
    });
