...
```typescript
import type { ScoreCreationBuilderData } from 'flat-api'
...
const example = {
  ...
  "builderData": null,
} satisfies ScoreCreationBuilderData
...
const exampleParsed = JSON.parse(exampleJSON) as ScoreCreationBuilderData
