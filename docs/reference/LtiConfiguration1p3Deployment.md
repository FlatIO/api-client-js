...
```typescript
import type { LtiConfiguration1p3Deployment } from 'flat-api'
...
} satisfies LtiConfiguration1p3Deployment
...
const exampleParsed = JSON.parse(exampleJSON) as LtiConfiguration1p3Deployment
