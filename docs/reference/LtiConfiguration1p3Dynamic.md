...
```typescript
import type { LtiConfiguration1p3Dynamic } from 'flat-api'
...
} satisfies LtiConfiguration1p3Dynamic
...
const exampleParsed = JSON.parse(exampleJSON) as LtiConfiguration1p3Dynamic
