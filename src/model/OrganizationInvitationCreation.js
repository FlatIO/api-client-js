...
class OrganizationInvitationCreation {
    ...
    constructor() { 
        ...
        OrganizationInvitationCreation.initialize(this);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new OrganizationInvitationCreation();
            ...
            if (data.hasOwnProperty('role')) {
                obj['role'] = OrganizationRoles.constructFromObject(data['role']);
            }
        }
        return obj;
    }
 ...
 * @member {String} email
 */
OrganizationInvitationCreation.prototype['email'] = undefined;

/**
 * @member {module:model/OrganizationRoles} organizationRole
 */
OrganizationInvitationCreation.prototype['organizationRole'] = undefined;

/**
 * @member {module:model/OrganizationRoles} role
 */
OrganizationInvitationCreation.prototype['role'] = undefined;
...
export default OrganizationInvitationCreation;
