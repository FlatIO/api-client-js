...
class GoogleClassroomCoursework {
    ...
    constructor() { 
        ...
        GoogleClassroomCoursework.initialize(this);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GoogleClassroomCoursework();
 ...
 * @member {String} id
 */
GoogleClassroomCoursework.prototype['id'] = undefined;

/**
 * State of the coursework
 * @member {String} state
 */
GoogleClassroomCoursework.prototype['state'] = undefined;

/**
 * Absolute link to this coursework in the Classroom web UI
 * @member {String} alternateLink
 */
GoogleClassroomCoursework.prototype['alternateLink'] = undefined;
...
export default GoogleClassroomCoursework;
