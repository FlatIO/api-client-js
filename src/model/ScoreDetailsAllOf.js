...
/**
 * The ScoreDetailsAllOf model module.
 * @module model/ScoreDetailsAllOf
 * @version 2.9.0
 */
class ScoreDetailsAllOf {
    /**
     * Constructs a new <code>ScoreDetailsAllOf</code>.
     * @alias module:model/ScoreDetailsAllOf
     */
    constructor() { 
        
        ScoreDetailsAllOf.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ScoreDetailsAllOf</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ScoreDetailsAllOf} obj Optional instance to populate.
     * @return {module:model/ScoreDetailsAllOf} The populated <code>ScoreDetailsAllOf</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ScoreDetailsAllOf();
...
export default ScoreDetailsAllOf;
