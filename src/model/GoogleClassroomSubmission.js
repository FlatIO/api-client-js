...
class GoogleClassroomSubmission {
    ...
    constructor() { 
        ...
        GoogleClassroomSubmission.initialize(this);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GoogleClassroomSubmission();
 ...
 * @member {String} id
 */
GoogleClassroomSubmission.prototype['id'] = undefined;

/**
 * State of the submission on Google Classroom
 * @member {String} state
 */
GoogleClassroomSubmission.prototype['state'] = undefined;

/**
 * Absolute link to this coursework in the Classroom web UI
 * @member {String} alternateLink
 */
GoogleClassroomSubmission.prototype['alternateLink'] = undefined;
...
export default GoogleClassroomSubmission;
