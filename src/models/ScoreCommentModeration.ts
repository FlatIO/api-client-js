...
export interface ScoreCommentModeration {
     ...
     * @type {ScoreCommentModerationReasonEnum}
     * @memberof ScoreCommentModeration
     */
...
/**
 * Check if a given object implements the ScoreCommentModeration interface.
 */
export function instanceOfScoreCommentModeration(value: object): value is ScoreCommentModeration {
    return true;
}

export function ScoreCommentModerationFromJSON(json: any): ScoreCommentModeration {
    return ScoreCommentModerationFromJSONTyped(json, false);
}

export function ScoreCommentModerationFromJSONTyped(json: any, ignoreDiscriminator: boolean): ScoreCommentModeration {
    if (json == null) {
        return json;
    }
    return {
...
export function ScoreCommentModerationToJSON(json: any): ScoreCommentModeration {
    return ScoreCommentModerationToJSONTyped(json, false);
}

export function ScoreCommentModerationToJSONTyped(value?: ScoreCommentModeration | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
